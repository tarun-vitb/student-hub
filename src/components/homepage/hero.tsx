...
export function Hero() {
  return (
    <Section className="pt-24 pb-16 lg:pt-32 lg:pb-24 overflow-hidden bg-gradient-to-br from-indigo-50/50 to-teal-50/50 dark:from-stone-900 dark:to-stone-800">
      <div className="relative">
        {/* Background Elements */}
        <div className="absolute inset-0 -z-10">
          <div className="absolute top-0 right-0 w-72 h-72 bg-gradient-to-bl from-indigo-200/20 to-transparent rounded-full blur-3xl" />
          ...
          <div className="relative">
            ...
            <div className="relative rounded-2xl bg-white dark:bg-stone-900 shadow-2xl border border-stone-200/50 dark:border-stone-700/50 p-6 transform rotate-1 hover:rotate-0 transition-transform duration-300">
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                ...
                <div className="text-center p-3 bg-stone-50 dark:bg-stone-800 rounded-lg">
                  <div className="text-2xl font-bold text-indigo-600">8.9</div>
            ...
            <div className="absolute -bottom-6 -left-6 w-20 h-20 bg-indigo-100 dark:bg-indigo-900 rounded-2xl flex items-center justify-center transform -rotate-12 animate-pulse">
